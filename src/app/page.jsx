...
export const metadata = {
  ...
  description:
    "Discover the latest and greatest movies and TV shows on Movies Hub. Explore popular, top-rated, trending, and upcoming titles.",
  openGraph: {
    title: "Movies Hub - Home",
    description:
      "Discover movies and TV shows. Explore popular, top-rated, and trending titles.",
    url: "https://movies.suhaeb.com/", // Replace with your production URL
    images: [
      {
        url: "https://movies.suhaeb.com/images/og-home.png", // IMPORTANT: Replace with an absolute URL to your OG image
        width: 1200,
        height: 630,
        alt: "Movies Hub - Discover Movies and TV Shows",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Discover movies and TV shows. Explore popular, top-rated, and trending titles.",
    // images: ['https://movies.suhaeb.com/images/twitter-home.png'], // Optional: specific Twitter image
  },
  alternates: { canonical: "https://movies.suhaeb.com/" }, // Replace with your production URL
};
